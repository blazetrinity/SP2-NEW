...
void CAIInteraction::InitAIText()
{
	...
	PlayerQuestion.push_back("How do I get a Shopping Cart?");
	PlayerQuestion.push_back("How much does an Apple cost?");
	PlayerQuestion.push_back("How are you?");
	PlayerQuestion.push_back("Do you know where is the ATM Machine?");
}
...
void CAIInteraction::randomText(){
	...
	value1 = rand() % 4;
	text = AIText[value];
	playerText = PlayerQuestion[value];
	time = 10.0f;
